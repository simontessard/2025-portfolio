            ...
            <div className="flex flex-col gap-6 md:gap-4 mb-6 md:mb-10">
                <div className="flex items-start justify-between w-full">
                    ...
                    <button onClick={() => lenis?.scrollTo('#top', {lerp: 0.01})}
                        ...
                        <svg className="shrink-0 size-12 md:size-16 xl:size-20 2xl:size-24 text-primary"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 82 82">
                            <path fillRule="evenodd" clipRule="evenodd"
                                  d="M12.252 41L41 12.252 69.749 41l-4.832 4.832-20.5-20.5v43.002h-6.834V25.331l-20.5 20.5L12.252 41z" fill="currentColor"/>
                        </svg>
                    </button>

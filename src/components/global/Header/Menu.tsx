        ...
        <div className="js-menu hidden fixed z-50 top-0 h-[100dvh] md:h-screen bg-black w-full flex-col justify-between p-3.5 md:p-6">
            ...
            <div className="flex max-lg:flex-col-reverse justify-between max-lg:pt-8 max-lg:gap-10 max-lg:h-full">
                ...
                <div className="flex flex-col justify-end">
                    ...
                    <div className="js-menu-contact opacity-0 flex gap-5 text-white font-primary font-medium uppercase w-full">
                ...
                <img src="https://picsum.photos/1000/1000" alt="Logo" style={{ clipPath: "polygon(0% 0%, 100% 0%, 100% 0%, 0% 0%)" }}
                     className="js-menu-img lg:aspect-[9/16] object-cover size-full max-lg:w-2/3 lg:max-w-md"/>

...
export default function MenuOpenButton() {
    return (
        <button onClick={openMenuFunction} className="group no-image overflow-hidden fixed z-50 top-4 right-3.5 md:top-6 md:right-6 size-fit uppercase md:text-lg md:leading-4 tracking-tight font-primary text-primary">

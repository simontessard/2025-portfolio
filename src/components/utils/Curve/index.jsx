...
const routePaths = {
    ...
    "project-ycyw": "/work/ycyw",
    "project-maxim": "/work/maxim",
    "project-cdc": "/work/cdc",
    "project-freelance": "/work/freelance",
}
...
const routeTranslations = {
    ...
    "project-ycyw": "Your Car Your Way",
    "project-maxim": "Site : Maxim",
    "project-cdc": "Site & Tunnel : ChefDeChantier",
    "project-freelance": "Portfolio Freelance",
};
    ...
    return (
        <main className='page curve'>
            ...
            <div style={{opacity: dimensions.width == null ? 1 : 0}} className='background'/>
                <motion.p className='route p-3 text-center text-white font-primary text-2xl md:text-3xl xl:text-4xl uppercase' {...anim(text)}>
                    {routeName}
                </motion.p>

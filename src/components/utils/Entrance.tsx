...
export default function Entrance() {
    ...
    useGSAP(() => {
        if (!entranceIsDone) {
            ...
            tl.to(['.js-up--first-3word', '.js-up--second-3word'], {opacity: 0, yPercent: -300, duration: 1, delay: 1, ease: 'power4.out'})
            tl.to(['.js-up--first-4word', '.js-up--second-4word'], {yPercent: -300, duration: 1.2, delay: .2, ease: 'power4.out'}, "<")

            // Disparition quatrième mots
            tl.to(['.js-up--first-4word', '.js-up--second-4word'], {opacity: 0, yPercent: -400, duration: 1, delay: 1, ease: 'power4.out'})

    ...
    return (
        <>
            <div className="flex flex-col w-full">
                ...
                <Link href="https://inivatourism.com/" target="_blank" className="group size-fit flex items-center gap-2 font-primary uppercase text-lg md:text-xl xl:text-2xl text-primary font-medium">
                    Visiter le site

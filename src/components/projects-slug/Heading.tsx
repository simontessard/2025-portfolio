            ...
            <div className="flex flex-col w-full">
                ...
                <div className="mb-10 xl:mb-0">
                    ...
                    <div className="flex max-xl:flex-col justify-between">
                        {/* Desc */}
                        <p className="font-primary md:text-lg md:leading-8 md:max-w-4xl xl:max-w-2xl 2xl:max-w-3xl uppercase text-primary mb-8 md:mb-12">
                            {project.description}
                        </p>

                        <div className="flex xl:justify-center gap-8 md:gap-10 lg:gap-12 xl:gap-14 2xl:gap-24 2xl:w-3/5">
                ...
                <Link href={project.url} target="_blank"
                      className="group size-fit flex items-center gap-2 font-primary uppercase text-lg md:text-xl text-primary font-medium">
                    Visiter le site
                    <svg
                        className="shrink-0 rotate-45 size-6 md:size-[1.65rem] md:group-hover:-translate-y-0.5 md:group-hover:translate-x-0.5 duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 82 82">

...
export default function GalleryDesktop({ gallery, title, desc, color = "#0156cf" }: GalleryDesktopProps ) {
    return (
        <div className="relative mb-16 md:mb-20">

            <style jsx global>{`.swiper-scrollbar-drag {
            ...
            <div className="flex items-end gap-5 md:gap-8 justify-between">
                <div style={{backgroundColor: `${color}4D`}}
                     className="scrollbar-custom-2 cursor-grab w-full h-2 md:h-1.5 md:hover:h-2 transition-transform mb-1"></div>
                <div className="flex gap-1.5 md:gap-2 mt-2 md:mt-4 w-fit">
                    <button
                        ...
                        <svg style={{color}} className="size-9 md:size-10 -rotate-90"

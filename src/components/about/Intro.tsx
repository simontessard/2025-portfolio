    ...
    return (
        <div className="flex max-lg:flex-col justify-between w-full mb-24 md:mb-40 lg:pr-8 xl:pr-20 2xl:pr-52">
            ...
            <div className="w-full lg:w-1/2 font-primary">
                <p className="text-lg lg:text-2xl md:leading-9 md:max-w-6xl uppercase text-primary lg:font-medium mb-8">
                ...
                <p className="text-lg lg:text-2xl md:leading-9 md:max-w-6xl uppercase text-primary lg:font-medium">

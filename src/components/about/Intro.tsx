    ...
    return (
        <div className="flex max-lg:flex-col justify-between w-full mb-24 md:mb-40 lg:pr-8 xl:pr-20 2xl:pr-52">
            ...
            <div className="w-full lg:w-1/2 font-primary">
                <Paragraph text="Je suis Simon TESSARD, un Développeur Web de 24 ans vivant à Rennes."/>
                <Paragraph text="En repoussant les limites visuelles à travers des projets, je façonne ma vision
                            ...
                            compétences."/>
                <Paragraph text="Mes compétences couvrent le Développement Web (Front-end et Back-end), le Web Design,
                            le tout avec une touche de créativité."/>
                <Paragraph text="Je suis disponible pour des missions de Freelance, n'hésitez pas à me contacter pour discuter de

    ...
    return (
        <Curve>
            ...
            <section className="min-h-screen">
                ...
                <article className="pt-20 md:pt-40 pb-16 md:pb-24">
                    <div className="px-3.5 prose prose-invert mx-auto max-w-3xl md:max-w-4xl 2xl:max-w-5xl mb-10 md:mb-14">
                    ...
                    <Image src={article.cover} alt={article.title} priority width={1920} height={1080} className="h-[30lvh] md:h-[50lvh] 2xl:h-[65lvh] object-cover mb-10 md:mb-14"/>

                    <div className="prose px-3.5 mx-auto !max-w-3xl md:!max-w-4xl 2xl:!max-w-5xl prose-h2:uppercase marker:text-black" dangerouslySetInnerHTML={{__html: content}}/>
